...
class ServerSideSensor(Sensor):
    ...
    def __str__(self, ServerSideSensor, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """
        __str__( (ServerSideSensor)arg1) -> object :
        
            C++ signature :
                struct _object * __ptr64 __str__(class carla::client::ServerSideSensor {lvalue})
        """
        pass
