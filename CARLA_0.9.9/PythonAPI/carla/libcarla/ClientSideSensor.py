...
class ClientSideSensor(Sensor):
    ...
    def __str__(self, ClientSideSensor, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """
        __str__( (ClientSideSensor)arg1) -> object :
        
            C++ signature :
                struct _object * __ptr64 __str__(class carla::client::ClientSideSensor {lvalue})
        """
        pass
