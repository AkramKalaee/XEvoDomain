...
class ObstacleDetectionEvent(SensorData):
    ...
    def __str__(self, ObstacleDetectionEvent, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """
        __str__( (ObstacleDetectionEvent)arg1) -> object :
        
            C++ signature :
                struct _object * __ptr64 __str__(class carla::sensor::data::ObstacleDetectionEvent {lvalue})
        """
        pass
