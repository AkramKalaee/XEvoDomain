...
class SetInitSpeed(AtomicBehavior):
    ...
    def initialise(self):
        ...
        self._control.speed = self._init_speed
        self._control.direction = CarlaDataProvider.get_transform(self._actor).get_forward_vector()
        self._actor.apply_control(self._control)
        # velocity = self._actor.get_velocity()
        # current_speed = math.sqrt(velocity.x * velocity.x + \
        #     velocity.y * velocity.y + \
        #     velocity.z * velocity.z)
        # print("set-speed-method vel = {} orig = {} for {}".format(self._actor.get_velocity(),current_speed, self._actor))
