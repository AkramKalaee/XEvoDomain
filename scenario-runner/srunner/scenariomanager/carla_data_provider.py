...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    def perform_carla_tick(timeout=5.0):
        ...
        try:
            ...
            raise Exception('perform_carla_tick')
    ...
    @staticmethod
    def dump():
        return CarlaDataProvider._is_dump

    @staticmethod
    def clear_buffer():
        CarlaDataProvider._is_dump = True
...
class CarlaActorPool(object):
    ...
    def create_blueprint(model, rolename='scenario', hero=False, autopilot=False, color=None, actor_category="car"):
        ...
        _actor_blueprint_categories = {
            ...
            'train': '',
            'tram': '',
            'pedestrian': 'walker.pedestrian.0007',
        }
    ...
    def request_new_actor(model, spawn_point, rolename='scenario', hero=False, autopilot=False,
        ...
        """
              ...
              """
        blueprint = CarlaActorPool.create_blueprint(model, rolename, color, actor_category)

        if random_location:
            actor = None
            while not actor:
                spawn_point = CarlaDataProvider._rng.choice(CarlaActorPool._spawn_points)
